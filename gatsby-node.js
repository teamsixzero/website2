...
exports.createSchemaCustomization = ({ actions }) => {
  ...
  type ContentfulBlockNextProject implements ContentfulReference & ContentfulEntry & Node @derivedTypes @dontInfer {
    ...
    node_locale: String!
    title: String
    project: ContentfulTemplateProject @link(by: "id", from: "template: project___NODE") @proxy(from: "template: project___NODE")
